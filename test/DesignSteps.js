  ...
  return (
    ...
    >
      ...
      <section className="self-stretch flex flex-row items-start justify-between relative max-w-full gap-5 text-center text-xl text-gray-200 font-product-sans lg:flex-wrap lg:justify-center">
        <div className="flex flex-row items-start justify-start min-w-[767px] max-w-full lg:flex-1 mq1050:min-w-full">
          <div className="flex-1 flex flex-col items-center justify-start pt-0 px-[47px] pb-[19px] box-border gap-10 max-w-full mq450:gap-5 mq450:pl-5 mq450:pr-5 mq450:box-border">
            ...
            <div className="self-stretch flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-3 shrink-0">
              ...
              <div className="self-stretch flex flex-col items-center justify-start gap-2 text-lg font-product-sans-medium">
                ...
                <div className="w-[303px] relative text-sm font-product-sans inline-block">
                  <p className="m-0">
                    Tell us about your new business and the brand vision you
                    want to bring to life. Our team of Atom creatives will use
                    this inspiration to start designing a logo that truly
                    reflects what makes your brand unique.
                  </p>
                </div>
              </div>
            </div>
          </div>
          <div className="flex-1 flex flex-col items-center justify-start pt-0 px-[47px] pb-[19px] box-border gap-10 max-w-full z-[1] ml-[-97px] mq450:gap-5 mq450:pl-5 mq450:pr-5 mq450:box-border">
            <div className="shadow-[0px_4px_8px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-gray-100 border-red border-[1px] border-solid flex flex-col items-center justify-center p-5">
              <img
            ...
            <div className="self-stretch flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-3 shrink-0">
              ...
              <div className="self-stretch flex flex-col items-center justify-start gap-2 text-lg font-product-sans-medium">
                ...
                <div className="w-[303px] relative text-sm font-product-sans inline-block">
                  ...
                  fine-tune each submission to your taste, making sure the
                  designs align with your vision.
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="w-[432px] !m-[0] absolute h-full top-[0px] right-[320px] bottom-[0px] flex flex-col items-center justify-start pt-0 px-[47px] pb-[19px] box-border gap-10 max-w-full z-[2]">
          <div className="shadow-[0px_4px_8px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-gray-100 border-red border-[1px] border-solid flex flex-col items-center justify-center p-5">
            <img
              className="w-10 h-10 relative"
              loading="lazy"
              alt=""
              src="/data-magnifying-glass.svg"
            />
          </div>
          <div className="self-stretch flex flex-col items-center justify-start pt-0 px-0 pb-1 gap-3 shrink-0">
            <h3 className="m-0 self-stretch relative text-inherit font-bold font-[inherit] mq450:text-base">
            ...
            <div className="self-stretch flex flex-col items-center justify-start gap-2 text-lg font-product-sans-medium">
              <div className="self-stretch relative">{`Audience Testing & Trademark Screening`}</div>
              <div className="w-[303px] h-[84px] relative text-sm font-product-sans inline-block shrink-0">
                <p className="m-0">
                  Got some top picks? We’ll test these designs with your target
                  audience to ensure they connect with your customers. Plus, our
                  team can handle Trademark screening for peace of mind.
                </p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-start pt-0 px-10 pb-[19px] box-border gap-10 min-w-[418px] max-w-full z-[3] lg:flex-1 mq450:gap-5 mq450:min-w-full">
          <div className="shadow-[0px_4px_8px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-gray-100 border-red border-[1px] border-solid flex flex-col items-center justify-center p-5">
            <img
              className="w-10 h-10 relative"
              loading="lazy"
            ...
            <div className="self-stretch flex flex-col items-center justify-start gap-2 text-lg font-product-sans-medium">
              ...
              <div className="w-[303px] h-[84px] relative text-sm font-product-sans inline-block shrink-0">
                <p className="m-0">
                  ...
                  chosen designer will be paid, and you’ll receive a unique logo
